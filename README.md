...
- For Windows: Locate the downloaded `.exe` file, double-click it, and follow the prompts.
- For macOS and Linux: Open your terminal, navigate to the folder where the file downloaded, and run the binary with the command `./vinyl_pipeline`, giving appropriate execute permission if needed.
...
2. Click on the "Load File" button and select your audio file.
3. Adjust the silence detection settings if needed. The defaults work well for most recordings.
4. Click "Process" to begin splitting your audio.
5. Once complete, save your tracks to your preferred directory.
